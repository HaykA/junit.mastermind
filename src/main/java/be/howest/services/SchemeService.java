...
public class SchemeService {
	...
	static {
		SCHEMES.put(0L, new Scheme(0L, 4, 6));
		SCHEMES.put(1L, new Scheme(1L, 4, 8));
		SCHEMES.put(2L, new Scheme(2L, 5, 8));
		SCHEMES.put(3L, new Scheme(3L, 5, 10));
		SCHEMES.put(4L, new Scheme(4L, 6, 8));
		SCHEMES.put(5L, new Scheme(5L, 6, 10));
		SCHEMES.put(6L, new Scheme(6L, 7, 10));
		SCHEMES.put(7L, new Scheme(7L, 8, 10));
	}
